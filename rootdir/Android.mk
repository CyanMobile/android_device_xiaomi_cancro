...
include $(CLEAR_VARS)
LOCAL_MODULE       := android_model_facea.dat
LOCAL_MODULE_TAGS  := optional eng
LOCAL_MODULE_CLASS := ETC
LOCAL_SRC_FILES    := etc/android_model_facea.dat
LOCAL_MODULE_PATH := $(TARGET_OUT_ETC)
include $(BUILD_PREBUILT)

include $(CLEAR_VARS)
LOCAL_MODULE       := android_model_faceg.dat
LOCAL_MODULE_TAGS  := optional eng
LOCAL_MODULE_CLASS := ETC
LOCAL_SRC_FILES    := etc/android_model_faceg.dat
LOCAL_MODULE_PATH := $(TARGET_OUT_ETC)
include $(BUILD_PREBUILT)
...
include $(CLEAR_VARS)
LOCAL_MODULE       := sdm_200_HOG3x3_Grid3x3_bin5_noproj_zero_reduced.bin
LOCAL_MODULE_TAGS  := optional eng
LOCAL_MODULE_CLASS := ETC
LOCAL_SRC_FILES    := etc/sdm_200_HOG3x3_Grid3x3_bin5_noproj_zero_reduced.bin
LOCAL_MODULE_PATH := $(TARGET_OUT_ETC)
include $(BUILD_PREBUILT)

include $(CLEAR_VARS)
LOCAL_MODULE       := sdm_200_HOG3x3_Grid3x3_bin5_noproj_zero_reduced.bin.pca
LOCAL_MODULE_TAGS  := optional eng
LOCAL_MODULE_CLASS := ETC
LOCAL_SRC_FILES    := etc/sdm_200_HOG3x3_Grid3x3_bin5_noproj_zero_reduced.bin.pca
LOCAL_MODULE_PATH := $(TARGET_OUT_ETC)
include $(BUILD_PREBUILT)
...
LOCAL_MODULE_TAGS  := optional eng
LOCAL_MODULE_CLASS := ETC
LOCAL_SRC_FILES    := etc/xtwifi.conf
LOCAL_MODULE_PATH := $(TARGET_OUT_ETC)
include $(BUILD_PREBUILT)

include $(CLEAR_VARS)
LOCAL_MODULE       := Diag.cfg
LOCAL_MODULE_TAGS  := optional eng
LOCAL_MODULE_CLASS := ETC
LOCAL_SRC_FILES    := etc/Diag.cfg
LOCAL_MODULE_PATH := $(TARGET_OUT_ETC)/modem
include $(BUILD_PREBUILT)
